...
class DronePhysicsEngine(pyee.EventEmitter):
    ...
    @staticmethod
    def decode_action(action : StepActionType) -> typing.Tuple[typing.Optional[StepRC], typing.Optional[DroneAction], dict]:
    ...
    def state(self, state):
        raise NotImplementedError("%s does not support setting state" % self.__class__.__name__)

    def reset(self, state : typing.Optional[PhysicsStateType] = None) -> PhysicsStateType:
